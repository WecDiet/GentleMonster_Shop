package com.gentlemonster.Configurations.Security;

import com.gentlemonster.Contants.Enpoint;
import com.gentlemonster.Filters.JwtTokenFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        httpSecurity
            ...
            .requestMatchers(HttpMethod.GET,
                ...
                String.format("%s/vouchers/*", Enpoint.API_PREFIX_ADMIN),
                String.format("%s/voucher_detail/*", Enpoint.Voucher.BASE),
                // Shop API USER
                ...
                String.format("%s/notifications", Enpoint.API_PREFIX_SHOP)
            ).permitAll()
            ...
            .requestMatchers(HttpMethod.POST,
                ...
                String.format("%s/new", Enpoint.Voucher.BASE),
                String.format("%s/warehouse_detail/{warehouseID}/add-user", Enpoint.Warehouse.BASE),
                ...
                String.format("%s/{notificationId}/read", Enpoint.Notification.BASE)
            ...
            .requestMatchers(HttpMethod.DELETE,
                ...
                String.format("%s/voucher_detail/*", Enpoint.Voucher.BASE),
                String.format("%s/warehouse_detail/{warehouseID}/delete-user/{userID}", Enpoint.Warehouse.BASE),
                String.format("%s/myaccount/address", Enpoint.Auth.BASE)
            ).permitAll()
            .anyRequest()
            .authenticated()
