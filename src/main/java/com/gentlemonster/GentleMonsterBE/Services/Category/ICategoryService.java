...
public interface ICategoryService {
    ...
    APIResponse<Boolean> editCategory(@PathVariable String categoryID, @RequestBody EditCategoryRequest editCategoryRequest);
    APIResponse<Boolean> deleteCategory(@PathVariable String categoryID);
}
